  ...
  return (
    ...
    >
        ...
        <Box>
          ...
          {isMobile && (
            <Typography variant="h6" gutterBottom sx={{ color: "red", mt: 2 }}>
              Mobile use is not recommended at the moment. Use a desktop or
              laptop.
            </Typography>
          )}
          <Box
      ...
      <Box sx={{ py: 5, backgroundColor: "#FFFFFF", mt: 4 }}>
        ...
        <Typography variant="h6" gutterBottom>
          Gather inspiration from our curated gallery of Miata builds. From
          track monsters to show cars, we've got it all.
        </Typography>
